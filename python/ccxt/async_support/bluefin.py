...
class bluefin(Exchange, ImplicitAPI):
    ...
    async def authenticate(self, params={}) -> dict:
        ...
        response = await self.authPostAuthV2Token(self.extend(request, params))
    ...
    async def refresh_access_token(self, params={}) -> dict:
        ...
        response = await self.authPutAuthTokenRefresh(self.extend(request, params))
        accessToken = self.safe_string(response, 'accessToken')
    ...
    async def fetch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        if limit is not None:
            request['limit'] = limit
        response = await self.accountGetApiV1AccountTrades(self.extend(request, params))
    ...
    async def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        if symbol is not None:
            request['symbol'] = self.bluefin_symbol(symbol)
        response = await self.tradeGetApiV1TradeOpenOrders(self.extend(request, params))
        market = self.market(symbol) if (symbol is not None) else None
    ...
    async def fetch_order(self, id: str, symbol: Str = None, params={}) -> Order:
        ...
        openResponse = await self.tradeGetApiV1TradeOpenOrders(self.extend(request, params))
        ...
        standbyResponse = await self.tradeGetApiV1TradeStandbyOrders(self.extend(request, params))
        ...
        tradeResponse = await self.accountGetApiV1AccountTrades(self.extend(tradeRequest, params))
    ...
    async def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}) -> Order:
        ...
        response = await self.tradePostApiV1TradeOrders(self.extend(request, cleanParams))
    ...
    async def cancel_order(self, id: str, symbol: Str = None, params={}) -> Order:
        ...
        if symbol is not None:
            request['symbol'] = self.bluefin_symbol(symbol)
        response = await self.tradePutApiV1TradeOrdersCancel(self.extend(request, params))
        return self.safe_order({
            'id': id,
            'info': response,
            'status': 'canceled',
    ...
    async def set_leverage(self, leverage: Int, symbol: Str = None, params={}) -> Any:
        ...
        return await self.tradePutApiV1TradeLeverage(self.extend(request, params))
    ...
    async def add_margin(self, symbol: str, amount: float, params={}) -> Any:
        return await self.adjust_margin(symbol, amount, 'Add', params)

    async def reduce_margin(self, symbol: str, amount: float, params={}) -> Any:
        return await self.adjust_margin(symbol, amount, 'Remove', params)

    async def adjust_margin(self, symbol: str, amount: float, operation: str, params={}) -> Any:
        await self.load_markets()
        await self.get_access_token()
        market = self.market(symbol)
        contractsConfig = self.safe_dict(self.options, 'contractsConfig', {})
        ...
        return await self.tradePutApiV1TradeAdjustIsolatedMargin(self.extend(request, params))
    ...
    async def withdraw(self, code: str, amount: float, address: str, tag: Str = None, params={}) -> Any:
        ...
        return await self.tradePostApiV1TradeWithdraw(self.extend(request, params))
