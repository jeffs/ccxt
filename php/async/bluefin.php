...
class bluefin extends Exchange {
    ...
    public function fetch_ticker(string $symbol, $params = array ()): PromiseInterface {
        ...
        $response = Async\await($this->exchangeGetV1ExchangeTicker(
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()): PromiseInterface {
        ...
        $response = Async\await($this->exchangeGetV1ExchangeDepth(
          $this->extend($request, $params),
        ));
    ...
    public function fetch_trades(string $symbol, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        ...
        $response = Async\await($this->exchangeGetV1ExchangeTrades(
          $this->extend($request, $params),
        ));
    ...
    public function fetch_ohlcv(string $symbol, $timeframe = "1m", ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        ...
        $response = Async\await($this->exchangeGetV1ExchangeCandlesticks(
          $this->extend($request, $params),
        ));
    ...
    public function fetch_funding_rate_history(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        ...
        $response = Async\await($this->exchangeGetV1ExchangeFundingRateHistory(
          $this->extend($request, $params),
        ));
