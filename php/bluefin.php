...
class bluefin extends Exchange {
    ...
    public function authenticate($params = array ()): array {
        ...
        $response = $this->authPostAuthV2Token ($this->extend($request, $params));
    ...
    public function refresh_access_token($params = array ()): array {
        ...
        $response = $this->authPutAuthTokenRefresh ($this->extend($request, $params));
        $accessToken = $this->safe_string($response, 'accessToken');
    ...
    public function fetch_my_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        $response = $this->accountGetApiV1AccountTrades ($this->extend($request, $params));
    ...
    public function fetch_open_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        $response = $this->tradeGetApiV1TradeOpenOrders ($this->extend($request, $params));
        $market = ($symbol !== null) ? $this->market($symbol) : null;
    ...
    public function fetch_order(string $id, ?string $symbol = null, $params = array ()): array {
        ...
        $openResponse = $this->tradeGetApiV1TradeOpenOrders ($this->extend($request, $params));
        ...
        $standbyResponse = $this->tradeGetApiV1TradeStandbyOrders ($this->extend($request, $params));
        ...
        $tradeResponse = $this->accountGetApiV1AccountTrades ($this->extend($tradeRequest, $params));
    ...
    public function create_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array ()): array {
        ...
        $response = $this->tradePostApiV1TradeOrders ($this->extend($request, $cleanParams));
    ...
    public function cancel_order(string $id, ?string $symbol = null, $params = array ()): array {
        ...
        $response = $this->tradePutApiV1TradeOrdersCancel ($this->extend($request, $params));
        return $this->safe_order(array(
            'id' => $id,
            'info' => $response,
            'status' => 'canceled',
    ...
    public function set_leverage(?int $leverage, ?string $symbol = null, $params = array ()): mixed {
        ...
        return $this->tradePutApiV1TradeLeverage ($this->extend($request, $params));
    }
    ...
    public function add_margin(string $symbol, float $amount, $params = array ()): mixed {
        return $this->adjust_margin($symbol, $amount, 'Add', $params);
    }

    public function reduce_margin(string $symbol, float $amount, $params = array ()): mixed {
        return $this->adjust_margin($symbol, $amount, 'Remove', $params);
    }

    public function adjust_margin(string $symbol, float $amount, string $operation, $params = array ()): mixed {
        $this->load_markets();
        $this->get_access_token();
        $market = $this->market($symbol);
        $contractsConfig = $this->safe_dict($this->options, 'contractsConfig', array());
        ...
        return $this->tradePutApiV1TradeAdjustIsolatedMargin ($this->extend($request, $params));
    }
    ...
    public function withdraw(string $code, float $amount, string $address, ?string $tag = null, $params = array ()): mixed {
        ...
        return $this->tradePostApiV1TradeWithdraw ($this->extend($request, $params));
    }
