...
export default class bluefin extends Exchange {
    ...
    suiSignPersonalMessage(message, privateKeyHex) {
    ...
    reconstructOrderFromTrades(id, trades, market = undefined) {
    ...
    async adjustMargin(symbol, amount, operation, params = {}) {
        await this.loadMarkets();
        await this.getAccessToken();
        const market = this.market(symbol);
        const contractsConfig = this.safeDict(this.options, 'contractsConfig', {});
